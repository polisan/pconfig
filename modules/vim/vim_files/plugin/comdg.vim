...
function! <SID>GetDoxFileHeader(leading_blank)
    ...
    let doc = doc. a:leading_blank."/***************************************************************************\n"
"    let doc = doc. a:leading_blank." * \n"
    let doc = doc. a:leading_blank." * Copyright (c) ".<SID>GetYear()." Yahoo.com, Inc. All Rights Reserved\n"
"    let doc = doc. a:leading_blank." * \n"
    let doc = doc. a:leading_blank." * Author: ".<SID>GetEmail()." (".<SID>GetUserName().")\n"
"    let doc = doc. a:leading_blank." * @date ".<SID>GetDate()."\n"
"    let doc = doc. a:leading_blank." * @brief \n"
"    let doc = doc. a:leading_blank." * \n"
    let doc = doc. a:leading_blank." **************************************************************************/"
...
map <F6> :call <SID>ValComment1()<CR>
map <F7> :call <SID>AddGroup()<CR>
